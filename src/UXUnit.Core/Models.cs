...
public sealed class TestMethodMetadata
{
    ...
    /// <summary>
    /// Gets the execution delegate for this test method.
    /// Generated by the source generator or manually provided for testing.
    /// </summary>
    public Func<CancellationToken, Task<TestResult>>? ExecuteAsync { get; init; }
