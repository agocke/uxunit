# NXTest.Runtime Design

## Overview

NXTest.Runtime is the execution engine that runs generated test code. It's **not an extensible framework** but rather a focused execution engine that takes test metadata as input and produces test results as output.
...
```
┌─────────────────────────────────────────────────────┐
│  Generated Code (from NXTest.Generators)            │
│  ├─ TestClassMetadata[]                             │
...
```csharp
// Generated by NXTest.Generators
